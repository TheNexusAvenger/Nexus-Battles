...
local NexusRoundSystem = require(script.Parent.Parent.Parent.Parent)

local NexusEventCreator = NexusRoundSystem:GetResource("NexusInstance.Event.NexusEventCreator")

local ReplicatedTable = NexusRoundSystem:GetResource("Common.Object.Base.ReplicatedContainer"):Extend()
ReplicatedTable:SetClassName("ReplicatedTable")
ReplicatedTable:AddFromSerializeData("ReplicatedTable")
NexusRoundSystem:GetObjectReplicator():RegisterType("ReplicatedTable",ReplicatedTable)
...
function ReplicatedTable:__new()
    ...
    if not NexusRoundSystem:IsServer() then
